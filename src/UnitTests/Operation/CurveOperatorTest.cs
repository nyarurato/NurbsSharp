...
{
    [TestFixture]
    public class CurveOperatorTest
    {
        [Test]
        public void FindClosestPoint_OnStraightLine_ReturnsPerpendicularPoint()
        {
            ...
            var (t, point, distance) = CurveOperator.FindClosestPoint(curve, target);
        ...
        public void FindClosestPoint_WithInitialGuess_ConvergesFaster()
        {
            ...
            var (t, point, distance) = CurveOperator.FindClosestPoint(curve, target, initialT: 0.7);
